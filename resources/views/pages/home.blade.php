                ...
                <div class="sidebyside-container">
                    ...
                    <div class="contact-container">
                        <div id="contactForm">
                            ...
                            <div class="minispace"></div><div class="minispace"></div>
                            ...
                            <div class="services BottomToTopAnim">
                                ...
                                <div class="reservation-category-list shutdownAnim">
                                    <input type="hidden" name="reservations" id="reservations">
                                    <div class="reservation-category-box BottomToTopAnim">
                                    ...
                                    <div class="reservation-category-box BottomToTopAnim">
                                        ...
                                        <div class="reservation-list">
                                            <div class="reservation-item">
                                                ...
                                                <div class="reservation-box">
                                                    <p>İğneli Epilasyon (Vücut)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>İğneli Epilasyon (Yüz)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Leke Tedavisi</p>
                                    ...
                                    <div class="reservation-category-box BottomToTopAnim">
                                        ...
                                        <div class="reservation-list">
                                            <div class="reservation-item">
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Tüm Vücut)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Ense)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Çene)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Dudak Üstü)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Göğüs)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Sırt)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Kol)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Yüz)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Bacak)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Bikini Bölgesi)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Koltuk Altı)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                ...
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Popo Üstü)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Göbek)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Lazer Epilasyon (Boyun)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="reservation-category-box BottomToTopAnim">
                                        ...
                                        <div class="reservation-list">
                                            <div class="reservation-item">
                                                ...
                                                <div class="reservation-box">
                                                    <p>G8 (Selülit Giderme ve Bölgesel İncelme) [Erkek]</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="reservation-category-box BottomToTopAnim">
                                        ...
                                        <div class="reservation-list">
                                            <div class="reservation-item">
                                                <div class="reservation-box">
                                                    <p>Saç Vitamini (Bölgesel)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                                <div class="reservation-box">
                                                    <p>Saç Vitamini (Komple)</p>
                                                    <button class="reservate-btn">+ Randevu Ekle</button>
                                                </div>
                                            </div>
                                        </div>
